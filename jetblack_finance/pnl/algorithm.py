...
def _find_match(
    ...
    return partial_trade, matched_trade, remainder
...
def _match(
    ...
    partial_trade, matched_trade, remainder = _find_match(
        pnl_state,
        partial_trade,
    ...
    pnl_state.matched.push(matched_trade, partial_trade)

    pnl_state = create_pnl_state(
        quantity,
        cost,
        realized,
        pnl_state.unmatched,
